...
const SVG_ICONS = {
  ...
  csharp: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M0 0h512v512H0" fill="#fff"/><path fill="#9b4f96" d="M64 256c0-106 86-192 192-192 54 0 103 22 138 58l-45 45c-24-24-57-38-93-38-72 0-130 58-130 127s58 127 130 127c36 0 69-14 93-38l45 45c-35 36-84 58-138 58-106 0-192-86-192-192z"/><text x="260" y="340" font-family="Arial,sans-serif" font-weight="bold" font-size="240" fill="#9b4f96">#</text></svg>',
} as const;
