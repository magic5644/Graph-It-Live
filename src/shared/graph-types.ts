...
export interface GraphNodeMetadata {
  ...
  /**
   * Path-based community assignment.
   * 0 = no domain. 1+ = cluster id. absent = not yet computed.
   */
  communityId?: number;
  /** Domain identity, independent of numeric assignment order; empty = no domain. */
  communityKey?: string;
}
