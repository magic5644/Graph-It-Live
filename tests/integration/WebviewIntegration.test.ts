...
describe('Webview Integration - Graph Rendering', () => {
    ...
    describe('Cycle Detection', () => {
        const cyclicDir = path.resolve(process.cwd(), 'tests/fixtures/cyclic-project/simple-cycle');
        let spider: Spider;
    ...
    describe('Reverse Dependencies', () => {
        const sampleDir = path.resolve(process.cwd(), 'tests/fixtures/sample-project');
        let spider: Spider;
    ...
    describe('Multi-file Navigation', () => {
        ...
        it('should correctly rebuild graph when switching files', async () => {
            ...
            const mainNodeInGraph1 = webviewGraph1.nodes.find(n => n.id.includes('main.ts'));
            ...
            const utilsNodeInGraph2 = webviewGraph2.nodes.find(n => n.id.includes('utils.ts'));
    ...
    describe('Python File Support', () => {
        const pythonDir = path.resolve(process.cwd(), 'tests/fixtures/python-project');
        let spider: Spider;
